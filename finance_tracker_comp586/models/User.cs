namespace finance_tracker_comp586
{
    ...
    public class User
    {
        ...
        public User(string username, string passwordHash, string salt, string firstName, string lastName, IEnumerable<OwnedStock>? ownedStocks)
        {
            this.username = username;
            ...
            this.walletAccount = new Wallet();
            this.savingsAccount = new Savings();
            this.brokerageAccount = new Brokerage(App.StockApi, ownedStocks);
        }
        ...
        public Wallet GetWallet() => this.walletAccount;
        public Savings GetSavings() => this.savingsAccount;
        public Brokerage GetBrokerage() => this.brokerageAccount;

        public Brokerage Brokerage
        {
            get => this.brokerageAccount;
            set => this.brokerageAccount = value;
        }
